...
public class Vezerlok extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, jMenuItem3, org.jdesktop.beansbinding.ELProperty.create("${action.enabled}"), this, org.jdesktop.beansbinding.BeanProperty.create("defaultCloseOperation"));
        ...
        pswJelszo.setText("cső te csöves");
        ...
        rdbVege.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rdbVegeActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addComponent(txtUjSzak, javax.swing.GroupLayout.PREFERRED_SIZE, 166, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(btnComboba, javax.swing.GroupLayout.PREFERRED_SIZE, 132, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
        ...
        if(jToggleButton1.isSelected()){
            if(chbHozzaFuz.isSelected()){
                for(int i = 0; i< jList1.getModel().getSize();i++){
                    listModel.addElement(jList1.getModel().getElementAt(i));
                }
            }
            if(rdbEleje.isSelected()){
                listModel.add(0,jComboBox1.getSelectedItem().toString());
            }
            else{
                listModel.add(jList1.getModel().getSize(),jComboBox1.getSelectedItem().toString());
            }
    ...
    private void chbHozzaFuzActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chbHozzaFuzActionPerformed
            rdbEleje.setEnabled(!rdbEleje.isEnabled());
            rdbVege.setEnabled(!rdbVege.isEnabled());
    }//GEN-LAST:event_chbHozzaFuzActionPerformed

    private void rdbVegeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rdbVegeActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_rdbVegeActionPerformed
    ...
    private void jPanel3ComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_jPanel3ComponentShown
        if(jRadioButton1.isSelected() || jRadioButton2.isSelected() || jRadioButton3.isSelected()){
            if(jCheckBox1.isSelected()){
                jTextArea1.setText("Hírlevelet kér");
            }else{
                jTextArea1.setText("Hírlevelet NEM kér");
            }
       }else{
    ...
    private void kilepes() {
        Icon icon = new ImageIcon(getClass().getResource("/nezet/kepek/exit.jpg"));
        int gomb = JOptionPane.showConfirmDialog(rootPane, "\nMindened elveszik ha ki lépsz mert nem mentek neked\n\n\tBiztosan ki lépsz?", "Kilépés", JOptionPane.OK_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE, icon);
